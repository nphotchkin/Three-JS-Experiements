...
addQuadraticCurveConvergingToCenter(-20, 5, 0, 5);
addQuadraticCurveConvergingToCenter(-15, 5, 0, 5);
addQuadraticCurveConvergingToCenter(-10, 5, 0, 5);
addQuadraticCurveConvergingToCenter(-5, 5, 0, 5);
...
function addQuadraticCurveConvergingToCenter(startX, startY, endX, endY) {
...
class TorusKnotSpawner {
    ...
    spawnMeshesEvery(miliseconds) {
        ...
        this.spawnMeshAtPosition(new THREE.Vector3(0, 5, 0));
